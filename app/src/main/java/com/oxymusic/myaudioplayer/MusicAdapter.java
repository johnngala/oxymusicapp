...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    //creates the music item view holder
    ...
    @Override
    //loads actual songs into  the views create above
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        //if you tap on a particular song,go to the player activity
    ...
    private void deleteFile(int position ,View v ){
        ...
        if (deleted){
            mContext.getContentResolver().delete(contentUri ,null ,null); // delete file from media store
...
//for showing arraylist from a search
